...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg_file', '-cfg', type=str, choices=["sky", "tub", "sketchy"],
                        default="sky", help="config file of the model")
    parser.add_argument('--data_dir', '-d', type=str, 
                        default="../datasets/SKY-Scene", help="path of the dataset")
    parser.add_argument('-m', '--mapping-path', 
                        default=None, 
                        type=str, help="path of the class mappings")
    # "../datasets/model_to_dataset_mappings/ldp_sketchy_to_freehand.json"
    ...
    # python3 infer.py -cfg "sketchy" -d ../datasets/CBSC-Sketchy -m ../datasets/model_to_dataset_mappings/ldp_sketchy_to_cbsc_sketchy.json